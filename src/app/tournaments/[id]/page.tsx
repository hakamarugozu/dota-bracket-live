  ...
  return (
    <main className="min-h-screen bg-[#070707] text-white">
      <header className="border-b border-white/10 bg-[#0b0b0d]">
        <div className="flex min-h-[68px] w-full items-center justify-between gap-4 px-4 sm:px-6 lg:px-8 xl:px-10">
          <Link href="/dashboard" className="flex min-w-0 items-center gap-3">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg border border-red-500/40 bg-red-600/10 shadow-[0_0_22px_rgba(220,38,38,0.14)]">
              <span className="text-lg font-black text-red-500">E</span>
            </div>
            ...
            <div className="min-w-0">
              ...
              <p className="mt-0.5 text-[10px] font-semibold uppercase tracking-[0.24em] text-red-500">
                Live
              </p>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/tournaments"
              className="hidden rounded-lg border border-white/10 bg-white/[0.03] px-3 py-2 text-xs font-semibold text-neutral-400 transition hover:border-white/20 hover:bg-white/[0.07] hover:text-white sm:inline-flex"
            >
              ← Mis torneos
            </Link>
            ...
            <button
              ...
              className="rounded-lg bg-red-600 px-3 py-2 text-xs font-black text-white transition hover:bg-red-500"
            >
...
/>
        ...
        <footer className="mt-8 flex flex-col gap-4 border-t border-white/10 py-6 text-xs text-neutral-700 sm:flex-row sm:items-center sm:justify-between">
          <p>Esports Bracket Live · Centro de administración del torneo</p>
