        ...
        <div className="border-b border-white/10 px-6 py-6">
          <div className="flex items-center justify-between">
            ...
            <button
              type="button"
              onClick={closeMobileMenu}
              className="flex h-9 w-9 items-center justify-center rounded-lg border border-white/10 text-neutral-400 transition hover:border-white/20 hover:text-white lg:hidden"
            >
              ✕
            </button>
          </div>
                  ...
                  <div className="min-w-0">
                    ...
                    <p
                      className={`mt-0.5 text-xs ${
                        isActive ? "text-red-300/70" : "text-neutral-600"
                      }`}
                    >
                      {item.description}
                    </p>
          ...
          <div className="flex h-[76px] items-center justify-between px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-4">
              <button
                ...
                className="flex h-10 w-10 items-center justify-center rounded-lg border border-white/10 bg-white/[0.03] text-xl text-neutral-300 transition hover:bg-white/[0.07] lg:hidden"
              >
                ☰
              </button>
